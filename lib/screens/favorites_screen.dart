...
class FavoritesScreen extends StatefulWidget {
  const FavoritesScreen({super.key, required this.scrollController});
  final ScrollController scrollController;

  @override
  State<FavoritesScreen> createState() => _FavoriteScreen();
}

class _FavoriteScreen extends State<FavoritesScreen> {
  @override
